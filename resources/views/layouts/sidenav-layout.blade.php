...
<body>
    ...
    <div id="sideNavRef" class="side-nav-open">
        ...
        <a href="{{route("event_page")}}" class="side-bar-item">
            <i class="fa fa-chevron-circle-right  text-dark"></i>
            <span class="side-bar-item-caption text-lg">Events</span>
        </a>

        <a href="{{route("event_category_page")}}" class="side-bar-item">
            <i class="fa fa-chevron-circle-right  text-dark"></i>
            <span class="side-bar-item-caption text-lg">Events category</span>
        </a>
